# CMP-SCR004-GUIDANCE - 신청 방법 3단계 + 안전 안내

**Task List Seq:** 45  |  **Category:** COMPONENT  |  **Priority:** P1  |  **Implementation Status:** IMPLEMENT
...
- `app/src/components/mates/Guidance.tsx`(create)

**이 목록 밖의 파일은 수정하지 않는다.**

## Functional AC

- "모집글 확인→메시지 전송→승인 알림" 3단계, 신고/차단 방법 요약, `/travel-tools` CTA
...
- 주어진 상태에서 다음 조건이 성립하는지 확인한다: "모집글 확인→메시지 전송→승인 알림" 3단계, 신고/차단 방법 요약, `/travel-tools` CTA
